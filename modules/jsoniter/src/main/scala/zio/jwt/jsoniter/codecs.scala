...
object codecs:
  ...
  given JsonValueCodec[NumericDate] = new JsonValueCodec[NumericDate]:
  ...
  given JsonValueCodec[Algorithm] = new JsonValueCodec[Algorithm]:
  ...
  given JsonValueCodec[Kid] = new JsonValueCodec[Kid]:
  ...
  given JsonValueCodec[Audience] = new JsonValueCodec[Audience]:
  ...
  given JsonValueCodec[JoseHeader] = new JsonValueCodec[JoseHeader]:
  ...
  given JsonValueCodec[RegisteredClaims] = new JsonValueCodec[RegisteredClaims]:
